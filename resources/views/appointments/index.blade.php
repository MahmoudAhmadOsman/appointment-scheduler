  ...
  <div class="row">
    <div class="col-md-2 profile__panel">
      <div class="patient__profile">
        <img src="http://www.writingcenter.uci.edu/wp-content/uploads/sites/28/2017/06/empty-calendar-2400px-copy.png"
    ...
    <div class="col-md-10">
      ...
      <div class="no_appointment text-center">
        <img src="https://www.sahilgraphics.com/wp-content/themes/shahil/assets/images/image-not-found.jpg" alt=""
          style="width: 15%; margin: auto;">
        <h3 class="text-danger" style="font-size: 14px;">No Appointment found!</h3>
        <a href="/appointments/create" class="btn btn-outline-success btn-sm" style="margin-bottom: 60px;"> Create New
          Appointment</a>
      </div>
      @endif
    </div>
